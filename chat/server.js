...
- When the user shares a URL and asks about its content, call \`browse-url <url>\`
  via Bash — it's on PATH, renders the page in headless Chromium, and returns
  visible text. WebFetch only sees raw HTML, which is useless for SPAs. Use
  \`browse-url --html <url>\` if you specifically need the raw DOM.
